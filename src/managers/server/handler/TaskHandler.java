...
public class TaskHandler extends BaseHttpHandler {
    ...
    /*------------------------------------------------------------------------------------------------------------------
    GET     http://localhost:8080/tasks/{idTask}  // получаем Задачу по id
    POST    http://localhost:8080/tasks           // создаём Задачу
    POST    http://localhost:8080/tasks/{idTask}  // обновляем Задачу по id
    DELETE  http://localhost:8080/tasks/{idTask}  // удаляем задачу по id
    ------------------------------------------------------------------------------------------------------------------*/
